    ...
    <main class="mx-auto container   px-[15px]">
        <div class="py-20">
            ...
            <div class="hidden space-x-2 md:flex justify-end mb-12">
                ...
                <a title="Add order" href="/views/group/create.php/?seedDb"
            ...
            <h1 class="uppercase font-bold text-4xl text-indigo-600 mb-12">Groups list</h1>
                        ...
                        <div class="overflow-x-auto relative">
                            <table class="w-full text-sm text-left  text-gray-400">
                                        ...
                                        <tr class=" border-b bg-gray-900 border-gray-700 text-center">
                                            ...
                                            <td class="pl-6 pr-3 py-4 flex  space-x-2">
                                                <a title="Edit order"
                                                   ...
                                                   href="/views/group/edit.php/?id=<?= $group['id'] ?>&seedDb">
                                                ...
                                                <a title="Delete order"
                                                   ...
                                                   href="/views/group/delete.php?id=<?= $group['id'] ?>&action=delete_group">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                         viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                         class="w-4 h-4">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <?php
                                    ...
                                    <td class="px-2 py-4 ">
                                        There are no groups, on database <strong>0</strong>, please add new group to
                                        database.
                                    </td>
                                <?php
                                endif; ?>
