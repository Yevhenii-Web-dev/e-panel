...
$user = $obj->edit((int) $_GET['id']);
$allUserGroups = $obj->editUserGroups((int) $_GET['id']);
...
<main class="mx-auto container px-[15px]">
    <div class="py-20">
        <h1 class="uppercase font-bold text-4xl text-indigo-600 mb-8">Edit Order</h1>
        <form id="mainForm" action="/views/user/update.php/?id=<?= $user['id'] ?>" method="POST" class="mb-14">
            <?php
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" id="password" name="password" value="<?= base64_decode($user['password']) ?>"
                        class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500"
                                ...
                                foreach ($items as $item): ?>
                                    ...
                                    <li>
                                        <div class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                                            <input id="checkbox-item-<?= $item['id'] ?>" <?= $checked ?> type="checkbox"
                                                name="group_ids[<?= $item['id'] ?>]" value="<?= $checked ? '1' : '0' ?>"
                                                class="checkbox-item w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
...
<script type="text/javascript">
    ...
    checkboxes.forEach(function (checkbox) {
        ...
        // Trigger change event immediately to log initial state
